var $page = function () {
    ...
    function addEvent() {
            ...
            if (row[index] == undefined || row[index] == null) {
                ...
                jqxConfirm(function () {
                    $.ajax({
                        type: "post",
                        dataType: "json",
                        url: "/bestPalace/menuAddress/deleteTreeMenuDetail",
        ...
        selector.$editButtonSave().on('click', function (e) {
            ...
            if (isSuccess) {
                ...
                var url = isAdd ? "/bestPalace/menuAddress/addTreeMenuDetail" : "/bestPalace/menuAddress/editTreeMenuDetail";
                jqxSubmit({
                    url: url,
                    form: selector.$form(),
                    success: function (data) {
        ...
        selector.$selectButtonSave().on('click', function (e) {
            ...
            if (language == null || language == "") {
                ...
                var url = (typeVal == 1) ? "/bestPalace/pageFactory/index" : "/bestPalace/bakFactory/index";
    ...
    function loadTreeMenuDetail(treeId) {
        if (treeId == null || treeId == "") {
            ...
            $.ajax({
                dataType: 'json',
                type: 'post',
                url: '/bestPalace/menuAddress/loadTreeMenuDetail',
                data: { menuId: treeId },
                success: function (data) {
                    if (data != null) {
                        bindJqxGrid(data);
    ...
    function loadLanguage() {
        $.getJSON('/bestPalace/menuAddress/loadLanguages', function (data) {
            if (data != null) {
                var option = {
                    dataType: 'json',
                    datafields: [
